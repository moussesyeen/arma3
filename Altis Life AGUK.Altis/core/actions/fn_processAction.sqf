...
_itemInfo = switch (_type) do {
	...
	case "heroin": {["heroin_unprocessed","heroin_processed",6000,(localize "STR_Process_Heroin")];};
	...
	case "cocaine": {["cocaine_unprocessed","cocaine_processed",12000,(localize "STR_Process_Cocaine")];};
	...
	case "meth": {["meth_unprocessed","meth_processed",8000,(localize "STR_Process_Meth")];};
