...
if((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship")) then
{
	...
	[[0,format["%2 your %3 is being scrapped by the police.",name player,(_vehicleData select 0) select 1,_vehicleName]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	...
	if((count crew _vehicle) == 0) then
	{
		...
		[[_vehicle, player],"TON_fnc_vehicleDead",false,false] spawn life_fnc_MP;
