...
["Setting up client","Your client is currently loading Esport Altis Life TH. Please wait."] call _doMsg;
0 cutFadeOut 9999999;
3 cutRsc ["SplashNoise","BLACK"];
//Maxi's purple menu titles!
...
["Loading Config Files","Your client is currently loading the Esport Altis Life TH config files. Please wait."] call _doMsg;
0 cutFadeOut 9999999;
...
["Finished Receiving Data","Data received, Welcome to Esport Altis Life TH!"] call _doMsg;
0 cutFadeOut 9999999;
...
[] spawn {
    while {true} do {
        ...
        hint "Your game has now been saved!";
    };
};
