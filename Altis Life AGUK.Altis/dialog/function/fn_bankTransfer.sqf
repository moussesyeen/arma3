...
[[format["1|%1 has transfered %3£ to %2. The bankaccount from %1 has now a value of %4£.",player getVariable["realname",name player],_unit getVariable["realname",name _unit],[_val] call life_fnc_numberText,[BANK] call life_fnc_numberText]],"Arma3Log",false,false] call life_fnc_MP;