...
_validMenus = [
	...
	"RscRadio","RscGroupRootMenu","RscDisplayRemoteMissions","RscMenuReply","RscMenuStatus","","#User:BIS_fnc_addCommMenuItem_menu","RscMenuMove","RscMenuFormations","RscMenuEngage","#WATCH59","RscMenuCombatMode","RscMenuTeam","#GET_IN", "RscMenuSelectTeam"
];
