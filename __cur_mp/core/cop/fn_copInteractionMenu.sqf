...
if(_curTarget isKindOf "House_F") exitWith {
	if((nearestObject [[16759.5,13628.9,0],"Land_Dome_Big_F"]) == _curTarget OR (nearestObject [[16759.5,13628.9,0],"Land_Airport_Tower_F"]) == _curTarget) then {
...
if(!((player distance (getMarkerPos "police_hq_1") < 40) OR  (player distance (getMarkerPos "police_hq_2") < 40) OR (player distance (getMarkerPos "cop_spawn_3") < 40) OR (player distance (getMarkerPos "cop_spawn_5") < 40) OR (player distance (getMarkerPos "jail_1") < 40) OR (player distance (getMarkerPos "cop_spawn_4") < 40))) then
{
