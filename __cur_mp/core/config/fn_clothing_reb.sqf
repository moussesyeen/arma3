...
switch (_filter) do
{
	...
	case 0:
	{
		[
			...
			["U_OG_Guerrilla_6_1",nil,17000],
			["U_O_CombatUniform_oucamo",nil,18500],
	...
	case 1:
	{
		[
			...
			["H_MilCap_oucamo",nil,1350],
			["H_HelmetIA",nil,1450],
			["H_HelmetSpecO_ocamo",nil,1400],
			["H_HelmetSpecO_Blk",nil,1200],
			["H_HelmetLeaderO_oucamo",nil,650]
		];
	};
