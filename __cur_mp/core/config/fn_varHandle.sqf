...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "carcush": {"life_inv_carcush"};
			case "carcus": {"life_inv_carcus"};
			case "hknife": {"life_inv_hknife"};
			case "carbomb": {"life_inv_carbomb"};
			case "jaws": {"life_inv_jaws"};
		};
	};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_carcush": {"carcush"};
			case "life_inv_carcus": {"carcus"};
			case "life_inv_hknife": {"hknife"};
			case "life_inv_carbomb": {"carbomb"};
			case "life_inv_jaws": {"jaws"};
		};
	};
};