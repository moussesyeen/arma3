...
switch (_var) do
{
	...
	case "life_inv_treasure": {(localize "STR_Item_Treasure")};
	case "life_inv_hgloves": {(localize "STR_Item_HGloves")};
	case "life_inv_uranium": {(localize "STR_Item_Uranium")};
	case "life_inv_euranium": {(localize "STR_Item_EUranium")};
	case "life_inv_sacid": {(localize "STR_Item_SAcid")};
	case "life_inv_sulfur": {(localize "STR_Item_Sulfur")};
	case "life_inv_rfuel": {(localize "STR_Item_RFuel")};
	case "life_inv_whiskey": {(localize "STR_Item_Whiskey")};
	case "life_inv_grapes": {(localize "STR_Item_Grapes")};
	case "life_inv_pgrapes": {(localize "STR_Item_PGrapes")};
	case "life_inv_detector": {(localize "STR_Item_Detector")};
	case "life_inv_ziptie": {(localize "STR_Item_ZipTie")};
	case "life_inv_moonshine": {(localize "STR_Item_Moonshine")};
	case "life_inv_vodka": {(localize "STR_Item_Vodka")};
	...
	case "life_inv_carcus": {(localize "STR_Item_Carcus")};
	case "life_inv_carcush": {(localize "STR_Item_CarcusH")};
	case "life_inv_hknife": {(localize "STR_Item_HKnife")};
	case "life_inv_carbomb": {(localize "STR_Item_CarBomb")};
	case "life_inv_jaws": {(localize "STR_Item_JawsOfLife")};
	//License Block
