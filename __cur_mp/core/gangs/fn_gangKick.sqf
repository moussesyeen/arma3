...
if(_group getVariable ["gang_owner",""] == _unitID) exitWith {hint localize "STR_GNOTF_KickOwner"};
...
[[4,grpPlayer,player],"TON_fnc_updateGang",false,false] spawn life_fnc_MP; //Update the database.
