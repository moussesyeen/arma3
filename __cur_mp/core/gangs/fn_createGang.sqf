...
if(gsn_lifeatm_cash < (__GETC__(life_gangPrice))) exitWith {hint format[localize "STR_GNOTF_NotEnoughMoney",[((__GETC__(life_gangPrice))-gsn_lifeatm_cash)] call life_fnc_numberText];};
