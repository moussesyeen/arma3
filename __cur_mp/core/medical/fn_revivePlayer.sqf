...
if!(_target isKindOf "Man")	exitWith {hint localize "STR_Medic_Animal"};
...
if(_target getVariable["Revive",FALSE]) exitWith {life_action_inUse = false;hint localize "STR_Medic_RevivedRespawned"; };
...
[(call life_revive_fee) + 15000,1,0] call life_fnc_handleMoney;
life_action_inUse = false;
_target setVariable["Revive",TRUE,TRUE];
[[profileName],"life_fnc_revived",_target,FALSE] spawn life_fnc_MP;
titleText[format[localize "STR_Medic_RevivePayReceive",_targetName,[20000] call life_fnc_numberText],"PLAIN"];
