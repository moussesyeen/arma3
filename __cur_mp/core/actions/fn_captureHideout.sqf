...
[[[0,1],format[localize "STR_GNOTF_CaptureSuccess",player getVariable["realname",name player],(group player) getVariable "gang_name" ]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
