...
if((_this select 3) in ["dive"] && !license_civ_dive && playerSide == civilian) exitWith { hint localize "STR_Shop_NotaDive"; closeDialog 0;};
if((_this select 3) in ["recruiter"] && (player getVariable["recruitPosition","none"] == "none")) exitWith { hint localize "STR_Shop_NotaRecruiter"; closeDialog 0;};
life_clothing_store = _this select 3;

//License Check?
if((_this select 3) in ["dive"] && playerSide != west) then
{
